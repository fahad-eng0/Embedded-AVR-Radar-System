...
# 2️⃣ تهيئة مكتبة Pygame ونظام الصوت
pygame.init()
...
while running:
    ...
    # 💡 السر هنا: مسح الطابور المتراكم وقراءة آخر سطر فقط لمنع تأخير الـ 10 ثواني
    if ser.in_waiting > 0:
        try:
